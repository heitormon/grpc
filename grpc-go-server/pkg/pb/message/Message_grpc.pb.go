...
func (c *messageServiceClient) SendMessage(ctx context.Context, in *MessageRequest, opts ...grpc.CallOption) (*MessageResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/com.heitor.grpc.MessageService/sendMessage", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _MessageService_SendMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.heitor.grpc.MessageService/sendMessage",
	}
...
var MessageService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "com.heitor.grpc.MessageService",
